...
def data_get():
 train24 = pd.read_csv("data/train_24.csv.f")
 train25 = pd.read_csv("data/train_25.csv.f")
 train26 = pd.read_csv("data/train_26.csv.f")
 train27 = pd.read_csv("data/train_27.csv.f")
 train28 = pd.read_csv("data/train_28.csv.f")
 train29 = pd.read_csv("data/train_29.csv.f")
 train30 = pd.read_csv("data/train_30.csv.f")
...
# print (train_.shape)
 ...
 print(train.shape)
 train.to_csv("data/train_deal_final.csv", index=False)
 test = pd.read_csv("data/test_deal_less.csv.f")
 test.to_csv("data/test_deal_final.csv", index=False) 

# data_get()

train_path = "data/data3/train_deal3.csv.low.24-31.f" # "train_xgb1.csv"
test_path = "data/data3/test_deal3.csv.low.ff" # "test_xgb.csv"
result_path = './fix_model/'
model_name = "fix"
...
df.to_csv("hccimportance.csv", index = False, encoding = "utf-8")
plt.figure()
df.plot()
